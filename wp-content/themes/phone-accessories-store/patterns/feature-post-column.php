 ...
 * Slug: phone-accessories-store/feature-post-column
 * Categories: template
 */
?>
...
<div class="wp-block-group alignwide" style="padding-bottom: 30px">
	...
	<div class="wp-block-columns alignwide">
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Popular News', 'phone-accessories-store' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
		...
		<div class="wp-block-column" style="flex-basis: 50%">
			<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/hero-banner.png'; ?>","id":817,"dimRatio":0,"focalPoint":{"x":"0.79","y":"0.45"},"minHeight":585,"contentPosition":"bottom center","isDark":false,"className":"has-no-hover-shadow-dark animated animated-fadeInUp"} -->
			<div
			...
			>
				...
				><img
					...
					alt=""
					src="<?php echo esc_url( get_template_directory_uri() );?>/assets/images/hero-banner.png"
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Recent News', 'phone-accessories-store' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
