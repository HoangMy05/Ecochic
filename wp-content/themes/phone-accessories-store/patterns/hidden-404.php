...
/**
 * Title: Hidden 404
 * Slug: phone-accessories-store/hidden-404
 * Categories: template
 */
?>
...
<h1 class="wp-block-heading has-text-align-center" style="font-size:43px"><?php echo esc_html__('Page Not Found', 'phone-accessories-store'); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__('This page could not be found. Maybe try a search?', 'phone-accessories-store'); ?></p>
<!-- /wp:paragraph -->
