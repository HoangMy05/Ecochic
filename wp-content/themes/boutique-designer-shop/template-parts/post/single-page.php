		...
		<div class="container">
			<div class="content-area my-5">
				<div id="main" class="site-main" role="main">
			       	<div class="row m-0">
			       		<?php if($boutique_designer_shop_single_post_option == 'single_right_sidebar'){ ?>
									...
									while ( have_posts() ) : the_post(); ?>
										<div id="single-post-section" class="single-post-page entry-content">
											<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
										        ...
										        <?php if( get_option('boutique_designer_shop_single_post_tag',false) != 'off'){ ?>
							      					<?php if (has_tag()) {
										...
										do_action( 'boutique_designer_shop_single_post_pagination' );

									endwhile; // End of the loop.
									?>
									<div class="clearfix"></div> 
									<?php if( get_option('boutique_designer_shop_similar_post',false) != 'off'){ ?>
