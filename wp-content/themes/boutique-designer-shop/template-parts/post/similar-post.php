...
$boutique_designer_shop_post_args = array(
    'posts_per_page'    => '3',
    'orderby'           => 'rand',
...
$boutique_designer_shop_ids = array();
foreach( $related as $term ) {
    $boutique_designer_shop_ids[] = $term->term_id;
}

$boutique_designer_shop_post_args['category__in'] = $boutique_designer_shop_ids; 

$related_posts = new WP_Query( $boutique_designer_shop_post_args );

if ( $related_posts->have_posts() ) : ?>
    <div id="Category-section" class="similar-post">
        <h3 class="text-center pb-3"><?php echo esc_html(get_theme_mod('boutique_designer_shop_similar_text',__('Explore More','boutique-designer-shop'))); ?></h3>
        <div class="row">
