 ...
 */
function swimwearstore_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function swimwearstore_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function swimwearstore_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function swimwearstore_sanitize_float( $input ) {
 ...
 */
function swimwearstore_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function swimwearstore_sanitize_html( $html ) {
 ...
 */
function swimwearstore_sanitize_image( $image, $setting ) {
 ...
 */
function swimwearstore_sanitize_nohtml( $nohtml ) {
 ...
 */
function swimwearstore_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function swimwearstore_sanitize_range_value( $number, $setting ) {
 ...
 */
function swimwearstore_sanitize_select( $input, $setting ) {
 ...
 */
function swimwearstore_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function swimwearstore_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function swimwearstore_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
