...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog-post'); ?>>
    <div class="listarticle">
        ...
        <header class="entry-header">
            ...
            <?php if ('post' == get_post_type() && ( get_theme_mod('comic_book_store_metafields_date', true) || get_theme_mod('comic_book_store_metafields_comments', true) || get_theme_mod('comic_book_store_metafields_author', true) || get_theme_mod('comic_book_store_metafields_time', true))) : ?>
                <div class="postmeta">
                    <?php if (get_theme_mod('comic_book_store_metafields_date', true)) : ?>
                        <div class="post-date">
                    ...
                    <?php endif; ?>  
                    <?php if (get_theme_mod('comic_book_store_metafields_comments', true)) : ?>  
                        <div class="post-comment">&nbsp; &nbsp;
                            <a href="<?php echo esc_url(get_comments_link()); ?>">
                            <span><?php echo esc_html(get_theme_mod('comic_book_store_metabox_seperator', '|'));?></span><i class="fa fa-comment"></i> &nbsp; <?php comments_number(); ?>
                                <span class="screen-reader-text"><?php comments_number(); ?></span>
                            </a>
                        </div>
                    <?php endif; ?>
                    <?php if (get_theme_mod('comic_book_store_metafields_author', true)) : ?>
                        <div class="post-author">&nbsp; &nbsp;
                            <a href="<?php echo $comic_book_store_author_link; ?>">
                            <span><?php echo esc_html(get_theme_mod('comic_book_store_metabox_seperator', '|'));?></span><i class="fas fa-user"></i> &nbsp; <?php echo esc_html($comic_book_store_author_name); ?>
                                <span class="screen-reader-text"><?php echo esc_html($comic_book_store_author_name); ?></span>
                            </a>
                        </div>
                    <?php endif; ?>
                    <?php if (get_theme_mod('comic_book_store_metafields_time', true)) : ?>
                        <div class="post-time">&nbsp; &nbsp;
                            <a href="#">
                            <span><?php echo esc_html(get_theme_mod('comic_book_store_metabox_seperator', '|'));?></span><i class="fas fa-clock"></i> &nbsp; <?php echo esc_html(get_the_time()); ?>
