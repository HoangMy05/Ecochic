...
<?php if ( get_theme_mod('comic_book_store_preloader', false) != "") { ?>
  <div id="preloader">
    <div id="status">&nbsp;</div>
  </div>
<?php }?>
...
<div class="mainhead <?php if( get_theme_mod( 'comic_book_store_sticky_header', false) == 1 ) { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
  <div class="container">
    <div class="header">
      <div class="row m-0">
        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12 align-self-center ps-0">
          <div class="logo text-center text-md-start">
            <?php if (get_theme_mod('comic_book_store_logo_enable', true)) { ?>
