 ...
 * Slug: feminine-store-rental/template-product-search-results
 * Categories: template
 * Inserter: false
 */
...
<!-- wp:query-no-results -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( 'No products were found matching your selection.', 'feminine-store-rental' ); ?></p>
<!-- /wp:paragraph -->
