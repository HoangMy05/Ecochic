...
/**
 * Title: Template Cart
 * Slug: feminine-store-rental/template-cart
 * Categories: template
 * Inserter: false
 */
...
<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'You may be interested in…', 'feminine-store-rental' ); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center with-empty-cart-icon wc-block-cart__empty-cart__title"><?php echo esc_html__( 'Your cart is currently empty!', 'feminine-store-rental' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><a href="<?php echo esc_url( home_url( '/shop' ) ); ?>"><?php echo esc_html__( 'Browse store', 'feminine-store-rental' ); ?></a></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'New in store', 'feminine-store-rental' ); ?></h2>
<!-- /wp:heading -->
