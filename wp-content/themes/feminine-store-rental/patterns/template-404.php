<?php
 /**
  * Title: Template 404
  * Slug: feminine-store-rental/template-404
  * Categories: template
  * Inserter: false
  */
...
<main class="wp-block-group" style="padding-bottom:0"><!-- wp:cover {"url":"<?php echo esc_url($feminine_store_rental_images[0]); ?>","id":79,"dimRatio":80,"overlayColor":"foreground","focalPoint":{"x":0.5,"y":0},"minHeight":300,"style":{"spacing":{"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|xx-large"}}}} -->
...
<?php echo esc_html__( '404', 'feminine-store-rental' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'This page could not be found. Maybe try a search?', 'feminine-store-rental' ); ?></p>
<!-- /wp:paragraph -->
