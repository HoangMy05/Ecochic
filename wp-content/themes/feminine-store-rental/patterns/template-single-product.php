 ...
 * Slug: feminine-store-rental/template-single-product
 * Categories: template
 * Inserter: false
 */
...
<h1 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'Single Product', 'feminine-store-rental' ); ?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
...
<h2 class="wp-block-heading"><?php echo esc_html__( 'Related products', 'feminine-store-rental' ); ?></h2>
<!-- /wp:heading -->
